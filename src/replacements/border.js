...
const replaceBorderWidth = (data) => {
  data = data.replaceAll(/--border-width-none/g, "--gl-border-width-none");
  data = data.replaceAll(/--border-width-thin/g, "--gl-border-width-xs");
  data = data.replaceAll(/--border-width-medium/g, "--gl-border-width-md");
  data = data.replaceAll(/--border-width-thick/g, "--gl-border-width-lg");
